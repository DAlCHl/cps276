<?php
    function parag_loop(){
        for ($numberOne = 1; $numberOne < 4; $numberOne++){  //loop for the paragraphs
...
<body>
	<div id="wrapper">
		<header>
			<h1>My Web Page</h1>  <!-- a part i changed for the header-->
		</header>
		<main>
			<h2>My name is Zeke Halliwill</h2> <!-- put my name in to the seccond header -->
			<!--<p>&lt;replace this paragraph element with three paragraphs that will be generated by a php loop&gt;</p> --> <!-- comment out this -->
            <?php
               echo parag_loop(); // put in the php loop for the three paragraphs
            ?>
			
		</main>
		<footer>
			<p>My Web Page &copy;2018</p> <!-- very bottom of the page footer -->
		</footer>
	</div>
